...
def plot_brightest_pixels_with_fitted_sine(image_path, num_pixels=10):
    ...
    # Find the 95th percentile bounding box
    ...
    # Draw a blue rectangle around the 95% bounding box
    rect = plt.Rectangle((min_col, min_row), box_width, max_row - min_row, edgecolor='blue', facecolor='none', linewidth=2, label="95% White Pixels")
    plt.gca().add_patch(rect)
    
    # Plot the fitted sinusoidal curve
    plt.plot(x_curve, y_curve, color='green', linewidth=2, label="Fitted Sinusoidal Curve")
...
if __name__ == "__main__":
    ...
    # Plot the brightest 2 pixels and the Otsu threshold with a bounding box and fitted vertical sinusoidal curve
